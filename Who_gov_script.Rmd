...
WhoGov_within <- WhoGov_within %>% 
  mutate(successor = case_when(
    ...
    country_isocode == "ZAF" & year <= 1980 ~ "ZBW, NAM",
    country_isocode == "ZAF" & year >= 1981 & year <= 1989 ~ "NAM",
    country_isocode == "SDN" & year <= 2011 ~ "SSD", 
    country_isocode == "ETH" & year <= 1992 ~ "ERI", 
    country_isocode == "IDN" & year >= 1975 & year <= 2001 ~ "TLS",
